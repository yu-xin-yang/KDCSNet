...
# 精确计算模型的Flops
def cal_flops_params_3(Net, input_size=(1, 1, 256, 256)):
    start = time.time()
...
def cal_flops_params_4(Net, input_size=(1, 1, 256, 256)):
    start = time.time()
    dummy_input = torch.randn(input_size)
    flops, params, results = count_flops_params(Net, dummy_input)
